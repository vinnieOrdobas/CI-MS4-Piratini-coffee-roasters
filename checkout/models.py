...
class OrderLineItem(models.Model):
    ...
    lineitems_total = models.DecimalField(max_digits=6, decimal_places=2, null=False, blank=False, editable=False)
    ...
    def save(self, *args, **kwargs):
        ...
        self.lineitems_total = self.product.price * self.quantity
        super().save(*args, **kwargs)

    def __str__(self):
        return f'SKU {self.products.sku} on order {self.order.order_number}'
