...
def add_to_wish_list(request, item_id):
    ...
    if profile.wish_list.exists():
        ...
        if product in wish_list.products.all():
            messages.warning(request, f'{product.card_name} already on your\
                 wish list.')
        else:
            wish_list.products.add(product)
            messages.success(request, f'{product.card_name} added to your\
                 wish list.')
...
def remove_from_wish_list(request, item_id):
    ...
    messages.success(request, f'{product.card_name} removed from your\
         wish list.')
